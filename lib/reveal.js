...
! function(e, t) {
    ...
    class b {
        ...
        startEmbeddedContent(e) {
            e && !this.Reveal.isSpeakerNotes() && (t(e, 'img[src$=".gif"]').forEach((e => {
                ...
                if ("boolean" != typeof t && (t = e.hasAttribute("data-autoplay") || !!o(e, ".slide-background")), t && "function" == typeof e.play)
    ...
    class R {
        ...
        update(e = !1) {
            ...
            if (Array.from(this.element.childNodes).forEach(((i, r) => {
                    i.classList.remove("past", "present", "future"), r < n.h ? i.classList.add(a) : r > n.h ? i.classList.add(o) : (i.classList.add("present"), s = i), (e || r === n.h) && t(i, ".slide-background").forEach(((e, t) => {
                        e.classList.remove("past", "present", "future"), t < n.v ? e.classList.add("past") : t > n.v ? e.classList.add("future") : (e.classList.add("present"), r === n.h && (s = e))
                    }))
    ...
    class P {
                ...
                if (a && (e.style.display = "none"), "false" !== t.dataset.autoAnimateUnmatched && !0 === this.Reveal.getConfig().autoAnimateUnmatched) {
                    ...
                    this.getUnmatchedAutoAnimateElements(t).forEach((e => {
                        let t = this.getAutoAnimateOptions(e, i),
                            n = "unmatched";
                        t.duration === i.duration && t.delay === i.delay || (n = "unmatched-" + x++, o.push(`[data-auto-animate="running"] [data-auto-animate-target="${n}"] { transition: opacity ${t.duration}s ease ${t.delay}s; }`)), e.dataset.autoAnimateTarget = n
                    }), this), o.push(`[data-auto-animate="running"] [data-auto-animate-target="unmatched"] { transition: opacity ${e}s ease ${n}s; }`)
                }
        ...
        autoAnimateElements(e, t, i, n, s) {
            ...
            if (!1 !== i.translate || !1 !== i.scale) {
                ...
                if (n || s) {
                    let e = [];
                    n && e.push(`translate(${t.x}px, ${t.y}px)`), s && e.push(`scale(${t.scaleX}, ${t.scaleY})`), o.styles.transform = e.join(" "), o.styles["transform-origin"] = "top left", r.styles.transform = "none"
                }
            }
            ...
            if (d.length > 0) {
                o.styles.transition = "none", r.styles.transition = `all ${a.duration}s ${a.easing} ${a.delay}s`, r.styles["transition-property"] = d.join(", "), r.styles["will-change"] = d.join(", "), l = '[data-auto-animate-target="' + s + '"] {' + Object.keys(o.styles).map((e => e + ": " + o.styles[e] + " !important;")).join("") + '}[data-auto-animate="running"] [data-auto-animate-target="' + s + '"] {' + Object.keys(r.styles).map((e => e + ": " + r.styles[e] + " !important;")).join("") + "}"
            }
            return l
        }
            ...
            [].slice.call(t.querySelectorAll(n)).forEach(((e, t) => {
                ...
                if (r[n] = r[n] || [], r[n].push(t), o[n]) {
                    const e = r[n].length - 1,
                        t = o[n].length - 1;
                    o[n][e] ? (l = o[n][e], o[n][e] = null) : o[n][t] && (l = o[n][t], o[n][t] = null)
                }
                l && e.push({
                    from: l,
                    to: t,
    ...
    class T {
        ...
        getIndicesFromHash(e = window.location.hash, t = {}) {
            ...
            if (/^[0-9]*$/.test(n[0]) || !i.length) {
                ...
                let i, s = e.hashOneBasedIndex || t.oneBasedIndex ? 1 : 0,
    ...
    function Y(a, l) {
        ...
        function Ee() {
            Y.slides.classList.add("no-transition"), g ? Y.wrapper.classList.add("no-hover") : Y.wrapper.classList.remove("no-hover"), se.render(), te.render(), ie.render(), de.render(), ce.render(), me.render(), Y.pauseOverlay = r(Y.wrapper, "div", "pause-overlay", E.controls ? '<button class="resume-button">Resume presentation</button>' : null), Y.statusElement = Re(), Y.wrapper.setAttribute("role", "application")
        }
        ...
        function We() {
            if (Y.wrapper && !ge.isPrintingPDF()) {
                if (!E.disableLayout) {
                    ...
                    const e = Ve(),
                        t = U;
                    Ke(E.width, E.height), Y.slides.style.width = e.width + "px", Y.slides.style.height = e.height + "px", U = Math.min(e.presentationWidth / e.width, e.presentationHeight / e.height), U = Math.max(U, E.minScale), U = Math.min(U, E.maxScale), 1 === U ? (Y.slides.style.zoom = "", Y.slides.style.left = "", Y.slides.style.top = "", Y.slides.style.bottom = "", Y.slides.style.right = "", De({
                        layout: ""
                    })) : (Y.slides.style.zoom = "", Y.slides.style.left = "50%", Y.slides.style.top = "50%", Y.slides.style.bottom = "auto", Y.slides.style.right = "auto", De({
                ...
                Y.viewport.style.setProperty("--slide-scale", U), ce.update(), se.updateParallax(), oe.isActive() && oe.update()
            }
        }
        ...
        function at(e, t, i, n) {
            ...
            void 0 !== t || oe.isActive() || (t = Xe(s[e])), p && p.parentNode && p.parentNode.classList.contains("stack") && $e(p.parentNode, v);
            const a = H.concat();
            H.length = 0;
            let o = u || 0,
                r = v || 0;
        ...
        function ct(e, i) {
            let n = t(Y.wrapper, e),
                ...
                r = !1;
            if (s) {
                E.loop && (i >= s && (o = !0), (i %= s) < 0 && (i = s + i, r = !0)), i = Math.max(Math.min(i, s - 1), 0);
                for (let e = 0; e < s; e++) {
                    let t = n[e],
                        s = E.rtl && !Ye(t);
                    t.classList.remove("past"), t.classList.remove("present"), t.classList.remove("future"), t.setAttribute("hidden", ""), t.setAttribute("aria-hidden", "true"), t.querySelector("section") && t.classList.add("stack"), a ? t.classList.add("present") : e < i ? (t.classList.add(s ? "future" : "past"), E.fragments && ht(t)) : e > i ? (t.classList.add(s ? "past" : "future"), E.fragments && ut(t)) : e === i && E.fragments && (o ? ut(t) : r && ht(t))
                }
                let e = n[i],
            ...
            if (s && void 0 !== u) {
                ...
                for (let o = 0; o < s; o++) {
                    let r = n[o],
                        l = t(r, "section"),
                        d = l.length;
                    if (e = Math.abs((u || 0) - o) || 0, E.loop && (e = Math.abs(((u || 0) - o) % (s - a)) || 0), e < a ? ee.load(r) : ee.unload(r), d) {
                        let t = Xe(r);
                        for (let n = 0; n < d; n++) {
                            let s = l[n];
                            i = o === (u || 0) ? Math.abs((v || 0) - n) : Math.abs(n - t), e + i < a ? ee.load(s) : ee.unload(s)
                        }
                    }
                }
        ...
        function ft(e) {
            ...
            if (e) {
                let i = Ye(e),
                    a = i ? e.parentNode : e,
                    o = yt();
                n = Math.max(o.indexOf(a), 0), s = void 0, i && (s = Math.max(t(e.parentNode, "section").indexOf(e), 0))
            }
            if (!e && m) {
    ...
    let _ = Y,
        J = [];
    return _.initialize = e => (Object.assign(_, new Y(document.querySelector(".reveal"), e)), J.map((e => e(_))), _.initialize()), ["configure", "on", "off", "addEventListener", "removeEventListener", "registerPlugin"].forEach((e => {
        _[e] = (...t) => {
            J.push((i => i[e].call(null, ...t)))
        }
    })), _.isReady = () => !1, _.VERSION = X, _
}));
